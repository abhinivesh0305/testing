...
def find_cython_implementation_modules():
    ...
    extensions = []
    for root, _, files in os.walk("elsai_stt"):
        for file in files:
...
def process_stt_file(root: str, file: str):
...
setup(
    ...
    description="The **Elsai Speech-to-Text** package provides an interface to transcribe audio using **Azure OpenAI Whisper**, enabling high-quality conversion of spoken content into text for downstream processing in LLM applications.",
