...
FOLDER_NAME="elsai_text_extractors"
PACKAGE_NAME="elsai-text-extractors"
INDEX_NAME="elsai-text-extractors"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-text-extractors/+simple/$PACKAGE_NAME/"
