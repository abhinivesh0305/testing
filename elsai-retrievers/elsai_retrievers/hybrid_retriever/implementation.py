...
from elsai_retrievers.config.loggerConfig import setup_logger

class HybridRetrieverImplementation:
    """
    ...
    def hybrid_retrieve(self, retrievers: list, question: str, chunks: list):
        """
