...
FOLDER_NAME="elsai_vectordb"
PACKAGE_NAME="elsai-vectordb"
INDEX_NAME="elsai-vectordb"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-vectordb/+simple/$PACKAGE_NAME/"
