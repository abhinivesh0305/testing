...
from elsai_vectordb.config.loggerConfig import setup_logger
import os

class PineconeVectorDbImplementation:
    """
    ...
    def __init__(self,index_name: str,pinecone_api_key, dimension: int = 1536):
        """
