...
FOLDER_NAME="elsai_ocr_extractors"
PACKAGE_NAME="elsai-ocr-extractors"
INDEX_NAME="elsai-ocr-extractors"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-ocr-extractors/+simple/$PACKAGE_NAME/"
