...
FOLDER_NAME="elsai_prompts"
PACKAGE_NAME="elsai-prompts"
INDEX_NAME="elsai-prompts"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-prompts/+simple/$PACKAGE_NAME/"
