...
FOLDER_NAME="elsai_model"
PACKAGE_NAME="elsai-model"
INDEX_NAME="elsai-model"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-model/+simple/$PACKAGE_NAME/"
