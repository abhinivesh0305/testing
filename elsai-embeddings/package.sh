...
FOLDER_NAME="elsai_embeddings"
PACKAGE_NAME="elsai-embeddings"
INDEX_NAME="elsai-embeddings"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-embeddings/+simple/$PACKAGE_NAME/"
