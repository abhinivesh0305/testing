...
FOLDER_NAME="elsai_utilities"
PACKAGE_NAME="elsai-utilities"
INDEX_NAME="elsai-utilities"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-utilities/+simple/$PACKAGE_NAME/"
