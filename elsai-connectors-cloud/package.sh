...
FOLDER_NAME="elsai_cloud"
PACKAGE_NAME="elsai-cloud"
INDEX_NAME="elsai-cloud-connectors"
DEVPI_SIMPLE_URL="https://elsai-core-package.optisolbusiness.com/root/elsai-cloud-connectors/+simple/$PACKAGE_NAME/"
